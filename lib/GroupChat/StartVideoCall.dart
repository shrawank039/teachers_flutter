...
class StartVideoCall extends StatefulWidget {
  ...
  StartVideoCall(this.room_id, this.user_id, this.user_name, this.subject_name, this.class_name, this.class_id);
      ...
      body: Container(
          child: Column(children: <Widget>[
            Expanded(
              child: Container(
                child: InAppWebView(
                    initialUrl: "https://conference.21century.in/video.php?type=teacher&room_id=$room_id&user_name=$user_name&user_id=$user_id&subject_name=$subject_name&class_name=$class_name",
