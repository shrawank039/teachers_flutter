...
class ViewAssignments extends StatefulWidget {
  ...
  ViewAssignments(
      this.classID, this.subjectID, this.subjectName, this.className);
...
class _ViewAssignmentsState extends State<ViewAssignments> {
          ...
          IconButton(
            ...
            onPressed: () async {
              Route route = MaterialPageRoute(
                  builder: (context) =>
                      SubmitAssignment(widget.classID, widget.subjectID));
  ...
  _getIndividualAssignment() async {
    final result = await ServerAPI()
        .getIndividualAssignment(widget.classID, widget.subjectID);
    return result["data"];
  }
}
